...
public class WorldGenMysticTree extends WorldGenAbstractTree{
    ...
    {
        this(p_i2027_1_, 4, 0, 0, false, NBlocks.MysticWoodLog, NBlocks.MysticLeaves);
    }

    public WorldGenMysticTree(boolean p_i2028_1_, int p_i2028_2_, int p_i2028_3_, int p_i2028_4_, boolean p_i2028_5_)
    {
        super(p_i2028_1_);
            ...
            else
            {
                ...
                if (isSoil && p_180709_3_.getY() < 256 - i - 1)
                {
                    ...
                    for (l = 0; l < i; ++l)
                    {
                        ...
                        {
                            this.func_175905_a(worldIn, p_180709_3_.up(l), Log, this.metaWood);
    ...
    //Modify if 
    private void GenSpecialVines(World worldIn, BlockPos p_175923_2_, int p_175923_3_)
    {
        this.func_175905_a(worldIn, p_175923_2_, vine, p_175923_3_);
        int j = 4;
