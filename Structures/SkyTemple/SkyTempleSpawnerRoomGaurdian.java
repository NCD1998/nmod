...
public class SkyTempleSpawnerRoomGaurdian implements IRoom{
	//Name
	private final String NAME = "Sky Temple Gaurdian Spawner Room";
	//Type
	...
	//Main Floor Block
	private final IBlockState floorBase = ReferenceSTBlocks.DARKTEMPLESTONE;
	//Main Wall Block
	private final IBlockState wallBase = ReferenceSTBlocks.DARKTEMPLESTONE;
	//Table Block
	...
	public SkyTempleSpawnerRoomGaurdian(){
		fillOutArray();
	}
